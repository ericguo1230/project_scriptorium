...
INSERT INTO "new_CodeExecution" ("code", "compilationTimeMs", "compileStderr", "compileStdout", "createdAt", "executionTimeMs", "id", "language", "status", "stderr", "stdin", "stdout", "userId") SELECT "code", "compilationTimeMs", "compileStderr", "compileStdout", "createdAt", "executionTimeMs", "id", "language", "status", "stderr", "stdin", "stdout", "userId" FROM "CodeExecution";
